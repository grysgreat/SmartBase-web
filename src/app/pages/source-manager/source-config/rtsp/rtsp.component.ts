...
@Component({
  ...
  styleUrls: ['./rtsp.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RtspComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.configlist$ = this.sp.showRtsp();
  ...
  deleteconfig(index :number){
    this.is_ok=this.sp.deleteRtsp(this.pconfiglist[index].id);
