...
@Component({
  ...
  styleUrls: ['./jsplumb.component.less'],
...
export class JsplumbComponent implements OnInit {
    ...
    draw() {
        ...
        //
        this.jsPlumbInstance.bind('click', function (conn:any, originalEvent:any) {
        ...
        //
        this.jsPlumbInstance.bind('connection', (connInfo:any) => {
            this.addMenu4Edge(connInfo);
            console.log(connInfo);
        });

        this.jsPlumbInstance.bind('connectionDetached', (connInfo:any) => {
            console.log(connInfo);
        });

        this.jsPlumbInstance.bind('connectionDrag', function (connection:any) {
            console.log('connection ' + connection.id + ' is being dragged. suspendedElement is ', connection.suspendedElement, ' of type ', connection.suspendedElementType);
        });

        this.jsPlumbInstance.bind('connectionDragStop', function (connection:any) {
            console.log('connection ' + connection.id + ' was dragged');
        });

        this.jsPlumbInstance.bind('connectionMoved', function (params:any) {
            console.log('connection ' + params.connection.id + ' was moved');
        });
        this.jsPlumbInstance.bind('click', (connection:any, e:any) => {
    ...
    addMenu4Edge(connInfo:any) {
        ...
        $.contextMenu({
            ...
            callback: function (key:any, opt:any, event:any) {
                console.log(`event`);
                console.log(key);
                console.log(opt);
                console.log(event);
